...
import { SegmentedControl, SimpleGrid, Stack, Container, Group, Title, Text, Button, Pagination } from "@mantine/core";
import { ProjectCard } from "@/app/_components/ProjectCard";
import type { ProjectCardModel } from "@/app/_components/ProjectCard";
import { IconPlus, IconInfoCircle } from "@tabler/icons-react";

export function HomeClient({ projects, page, total, totalPages }: { projects: ProjectCardModel[] }) {
